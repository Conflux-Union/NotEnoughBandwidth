...
//#else
//$$ public record IndexSyncPayload(List<ResourceLocation> types, String serverId) {
//$$     public static final ResourceLocation CHANNEL = new ResourceLocation(ModConstants.NETWORK_NAMESPACE, "index_sync");
//#endif
    ...
    public static IndexSyncPayload read(FriendlyByteBuf buf) {
